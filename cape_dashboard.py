...
pages = st.navigation([
    ...
    st.Page("pages/1_Carbon_Risk_Scores.py",  title="AI Training for ERPsim", icon="📈"),
    st.Page("pages/7_LAX_Case_Study.py",      title="LAX Case Study",       icon="✈️"),
    st.Page("pages/3_Emissions_By_Route.py",  title="LAX Emissions by Route", icon="📊"),
    st.Page("pages/2_What_If_Simulator.py",   title="LAX What-If Simulator", icon="⚡"),
