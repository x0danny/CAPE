...
if prompt := st.chat_input("Ask anything about LAX air freight, carbon risk, or CAPE research..."):
    ...
    with st.chat_message("assistant"):
        ...
        st.markdown(answer)
        if searched:
            st.caption("🔍 *This answer used live web search results and was generated by AI. Verify important claims independently.*")
        elif not _pattern_answer(prompt, ctx):
            st.caption("🤖 *This answer was generated by AI using CAPE's data context. It may not be perfectly accurate.*")
        if errors:
